# Graph Report - calc  (2026-08-05)

## Corpus Check
- 93 files · ~68,945 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1005 nodes · 1974 edges · 91 communities (52 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10d0eae3`
...
1. `cn()` - 223 edges
2. `syncNow()` - 24 edges
3. `isPocketBaseConfigured()` - 22 edges
...
Cohesion: 0.07
Nodes (83): CachedShift, CalcDB, deleteShift(), dequeue(), Dictionaries, DictItem, enqueue(), getDb() (+75 more)

### Community 1 - "PocketBase Sync Layer"
Cohesion: 0.06
Nodes (72): DEFAULT_DICTIONARIES, formatRuDate(), fromIsoDate(), isPinnedMarkingNumber(), markingTypesMap(), sortedMarkingNumbers(), markingNumberImageUrl(), getCurrentUserFullName() (+64 more)
...
Cohesion: 0.13
Nodes (19): DEFAULT_MARKING_TYPE_BY_NUMBER, formatMarkingNumWithDescription(), HIDDEN_MARKING_NUMBERS, isMarkingNumberVisibleInPicker(), LOCATION_KEYWORDS, MARKING_NUM_ALIASES, MARKING_NUMBER_VARIANT_ALIASES, MARKING_NUMBERS_WITH_DESCRIPTION (+11 more)
...
Cohesion: 0.26
Nodes (16): clearUserScopedData(), ensureUserDataScope(), authFailureMessage(), clearSession(), clearStubSession(), ensureAuthProfile(), ensureServerSession(), isAuthRejected() (+8 more)
...
Cohesion: 0.18
Nodes (11): class-variance-authority, clsx, dependencies, class-variance-authority, clsx, @radix-ui/react-slider, @radix-ui/react-slot, @tanstack/react-virtual (+3 more)
...
Cohesion: 0.10
Nodes (21): DateRange, MiniCalendar(), NotifyUser, computeUserStats(), endOfDay(), getSnapshot(), peekSyncSnapshot(), startOfDay() (+13 more)
...
Cohesion: 0.20
Nodes (8): App(), RequireAuth(), router, isAuthenticated(), subscribeAuthStore(), AuthPage(), FieldErrors, RegisterPage()
...
### Community 72 - "date-fns"
Cohesion: 0.35
Nodes (12): isPocketBaseConfigured(), ensurePushSubscription(), isPushSupported(), listNotifyUsers(), resolveVapidPublicKey(), sendAppNotification(), urlBase64ToUint8Array(), vapidPublicKeyFromEnv() (+4 more)

### Community 73 - "idb"
Cohesion: 0.29
Nodes (10): applyStoredGraphicsQuality(), applyToDom(), emit(), getGraphicsQuality(), GraphicsQuality, listeners, readStored(), setGraphicsQuality() (+2 more)

### Community 74 - "@tanstack/react-virtual"
Cohesion: 0.29
Nodes (6): Web Push (пробный), Логи, Ограничения платформ, Откат, Поведение, Что нужно на VPS
...
### Community 83 - "toggle-group.tsx"
Cohesion: 0.43
Nodes (5): ToggleGroup(), ToggleGroupContext, ToggleGroupItem(), Toggle(), toggleVariants

### Community 84 - "pocketbase.ts"
Cohesion: 0.47
Nodes (5): getPocketBaseUrl(), pb, pbFileUrl(), resolvePocketBaseUrl(), url
...
## Knowledge Gaps
- **259 isolated node(s):** `fix-nginx-sw-cache.sh script`, `name`, `private`, `version`, `type` (+254 more)
...
- **Why does `cn()` connect `Avatar Breadcrumb UI` to `App Shell Routing`, `shadcn Input Sheet`, `Carousel React Deps`, `Badge Checkbox UI`, `Alert Dialog UI`, `Command Palette UI`, `Context Menu UI`, `Dropdown Menu UI`, `popover.tsx`, `select.tsx`, `Select UI Kit`, `toggle-group.tsx`, `Radix Slider`, `Accordion UI`, `Alert UI`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Radix Switch Tabs` to `Carousel React Deps`, `ESLint Package Config`, `Navigation Menu UI`, `lucide-react Icons`, `pocketbase SDK`, `Radix Accordion`, `Radix Alert Dialog`, `Radix Aspect Ratio`, `Radix Checkbox`, `Radix Collapsible`, `Radix Dialog`, `Radix Dropdown`, `Radix Hover Card`, `Radix Label`, `Radix Menubar`, `Radix Nav Menu`, `Radix Popover`, `Radix Radio Group`, `Radix Scroll Area`, `Radix Select`, `Radix Separator`, `Radix Toggle`, `Radix Toggle Group`, `react-dom`, `Resizable Panels`, `react-router`, `tailwind-merge`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-progress`, `toggle-group.tsx`, `clsx`, `@radix-ui/react-accordion`, `@radix-ui/react-avatar`, `react-router`, `web-push`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `react` connect `Carousel React Deps` to `shadcn Input Sheet`, `toggle-group.tsx`, `Radix Switch Tabs`, `Radix Slider`, `Accordion UI`?**
