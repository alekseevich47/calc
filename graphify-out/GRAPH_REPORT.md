...
## Corpus Check
- Corpus is ~45,301 words - fits in a single context window. You may not need a graph.

## Summary
- 756 nodes · 1426 edges · 70 communities (34 shown, 36 thin omitted)
...
4. `react` - 16 edges
5. `confirmShift()` - 16 edges
6. `isPocketBaseConfigured()` - 14 edges
7. `pullFromServer()` - 14 edges
8. `pushQueueItem()` - 14 edges
9. `getDb()` - 13 edges
10. `getCurrentUserFullName()` - 13 edges
...
Cohesion: 0.08
Nodes (69): CachedShift, CalcDB, clearUserScopedData(), deleteShift(), dequeue(), Dictionaries, DictItem, enqueue() (+61 more)

### Community 1 - "PocketBase Sync Layer"
Cohesion: 0.06
Nodes (61): DEFAULT_DICTIONARIES, markingTypesByNumberId(), markingTypesMap(), sortedMarkingNumbers(), getPocketBaseUrl(), markingNumberImageUrl(), pb, pbFileUrl() (+53 more)

### Community 2 - "App Shell Routing"
Cohesion: 0.08
Nodes (40): App(), RequireAuth(), router, BottomNav(), GlobalStyles(), STATUS_CONFIG, StatusBadge(), SyncStatus (+32 more)
...
Cohesion: 0.22
Nodes (9): class-variance-authority, dependencies, class-variance-authority, @radix-ui/react-switch, @radix-ui/react-tabs, @radix-ui/react-tooltip, @radix-ui/react-switch, @radix-ui/react-tabs (+1 more)
...
- **Why does `cn()` connect `Avatar Breadcrumb UI` to `shadcn Input Sheet`, `Carousel React Deps`, `Badge Checkbox UI`, `Alert Dialog UI`, `Command Palette UI`, `Menubar UI Kit`, `Context Menu UI`, `Dropdown Menu UI`, `Drawer UI Kit`, `Select UI Kit`, `Navigation Menu UI`, `Accordion UI`, `Alert UI`, `Popover UI`?**
  _High betweenness centrality (0.239) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Radix Switch Tabs` to `Carousel React Deps`, `ESLint Package Config`, `clsx Utility`, `date-fns Library`, `idb Library`, `lucide-react Icons`, `pocketbase SDK`, `Radix Accordion`, `Radix Alert Dialog`, `Radix Aspect Ratio`, `Radix Avatar`, `Radix Checkbox`, `Radix Collapsible`, `Radix Context Menu`, `Radix Dialog`, `Radix Dropdown`, `Radix Hover Card`, `Radix Label`, `Radix Menubar`, `Radix Nav Menu`, `Radix Popover`, `Radix Progress`, `Radix Radio Group`, `Radix Scroll Area`, `Radix Select`, `Radix Separator`, `Radix Slider`, `Radix Slot`, `Radix Toggle`, `Radix Toggle Group`, `react-dom`, `Resizable Panels`, `react-router`, `tailwind-merge`?**
  _High betweenness centrality (0.141) - this node is a cross-community bridge._
- **Why does `react` connect `Carousel React Deps` to `shadcn Input Sheet`, `Badge Checkbox UI`, `Radix Switch Tabs`?**
